...
APPLICATION_DOWNLOAD_LIST = [artnetominator,bulk_rename_utility,disguise,free_file_sync,github,midi_ox,myffmpeg,ndi,netsetman,obs,parsec,protokol,realvnc,rufus,sublime,tailscale,tightvnc]
